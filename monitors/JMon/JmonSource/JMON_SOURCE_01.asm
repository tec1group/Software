...
;BY JIM ROBERTSON
;
;FILENAME   : JMON_MJ.ASM
;VERSION    : 1.0
;
;This version has been cleaned up by Mark Jelic, June 2021
;Removed much of the Tape routines and added in the Keyboad
;remap routine, originally written by Ben Grimmett for MON1B.
;
;[Lovingly] RESTORED TO SOURCE FROM PDF LISTING(S) FEBRUARY 2021
;[by Craig Jones. What a champion effort! - MJ]
;
;*** KEYBOARD READER/VALIDATER CONDITIONAL ASSEMBLY ***
